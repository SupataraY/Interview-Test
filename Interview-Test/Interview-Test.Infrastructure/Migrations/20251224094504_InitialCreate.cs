    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissionTb", x => new { x.RoleId, x.PermissionId });
                    table.ForeignKey(
                        name: "FK_RolePermissionTb_PermissionTb_PermissionId",
                        column: x => x.PermissionId,
                        principalTable: "PermissionTb",
                        principalColumn: "PermissionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePermissionTb_RoleTb_RoleId",
                        column: x => x.RoleId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoleMappingTb", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissionTb_PermissionId",
